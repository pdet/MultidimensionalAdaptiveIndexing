...
TEST_CASE( "Test Cracking KDTree Narrow", "[CrackingKDTreeNarrow]" ) {
    const string workload_path = "cracking_kd_tree_narrow_test_queries";
    const string table_path = "cracking_kd_tree_narrow_test_data";
    ...
    auto alg = IndexFactory::getIndex("Cracking KD-Tree Narrow");
