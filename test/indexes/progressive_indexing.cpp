...
TEST_CASE(
        "Test Progressive Indexing\
        [10000 rows, 5 dimensions, 0.5 selectivity, 1000 queries]",
        "[PI]" )
{
    TestHelper::test(10000, 5, 0.5, 1000, CrackingKDTree::ID);
}
...
TEST_CASE(
        ...
        "[PI]" )
{
    TestHelper::test(100000, 2, 0.1, 1000, CrackingKDTree::ID);
}
...
TEST_CASE(
        ...
        "[PI]" )
{
    TestHelper::test(100000, 24, 0.001, 1000, CrackingKDTree::ID);
}
