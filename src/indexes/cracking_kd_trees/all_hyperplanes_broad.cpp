...
AllHyperplanesBroad::AllHyperplanesBroad(std::map<std::string, std::string> config)
    : AbstractCrackingKDTree(config) {}

AllHyperplanesBroad::~AllHyperplanesBroad(){}

void AllHyperplanesBroad::adapt_index(Query& query){
